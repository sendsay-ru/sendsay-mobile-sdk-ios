...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
  This library acts as an extension-safe complement to the Sendsay SDK. It allows for support of rich push notifications and dynamic actions.
  ...
  s.source_files    = ["SendsaySDK/SendsaySDK-Notifications/**/*.swift", "SendsaySDK/SendsaySDKShared/**/*.swift"]
  s.resource_bundles = {'SendsaySDK-Notifications' => ['SendsaySDK/SendsaySDK-Notifications/Supporting Files/PrivacyInfo.xcprivacy']}
  s.exclude_files   = "SendsaySDK/SendsaySDK/**/*"
