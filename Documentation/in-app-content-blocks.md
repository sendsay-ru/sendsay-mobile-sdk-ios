...
![In-app content blocks in the example app](https://raw.githubusercontent.com/sendsay/sendsay-ios-sdk/main/Documentation/images/in-app-content-blocks.png)
...
```swift
Sendsay.shared.inAppContentBlocksManager?.prepareInAppContentBlockView(placeholderId: "example_content_block", indexPath: 5)
```

Use the SDK's `refreshCallback` to reload your entire table view or collection view when needed:

```swift
Sendsay.shared.inAppContentBlocksManager?.refreshCallback = { [weak self] indexPath in
    onMain {
...
> 📘
>
> Refer to [InAppContentBlocksViewController](https://github.com/sendsay/sendsay-ios-sdk/blob/main/SendsaySDK/Example/Views/InAppContentBlocks/InAppContentBlocksViewController.swift) in the [example app](https://documentation.bloomreach.com/engagement/docs/ios-sdk-example-app) for a reference implementation.
...
```swift
Sendsay.shared.inAppContentBlocksManager?.prefetchPlaceholdersWithIds(ids: ["placeholder_1", "placeholder_2"])
```
...
> 📘
>
> Refer to [InAppContentBlocksViewController](https://github.com/sendsay/sendsay-ios-sdk/blob/main/SendsaySDK/Example/Views/InAppContentBlocks/InAppContentBlocksViewController.swift) in the [example app](https://documentation.bloomreach.com/engagement/docs/ios-sdk-example-app) for a working example.
...
![Screenshot](https://raw.githubusercontent.com/sendsay/sendsay-ios-sdk/main/Documentation/images/actiontype.png)
...
protocol InAppCbViewDelegate {
    func showMessage(_ contentBlock: SendsaySDK.InAppContentBlockResponse)
    func showNoMessage()
    func showError()
    func hideMe()
}
