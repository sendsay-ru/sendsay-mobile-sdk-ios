...
* установку приложения (после первой установки и после вызова [anonymize](#анонимизация)).
...
> ❗️
>
> SDK сохраняет данные клиента в локальном кэше. Чтобы очистить кэш, используйте [anonymize](#анонимизация).
