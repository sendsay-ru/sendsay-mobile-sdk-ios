...
/// the object in case of success, otherwise return the error from the Sendsay API.
///
/// - success(T)
/// - failure(Error)
...
/// when the result is success. For error messages it return the error from the Sendsay API.
/// Used for cases like flushing the data to the Sendsay API.
///
/// - success
/// - failure(Error)
