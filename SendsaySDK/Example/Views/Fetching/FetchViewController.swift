...
class FetchViewController: UIViewController {
    ...
    @IBAction func segment(_ sender: Any) {
        Sendsay.shared.getSegments(force: true, category: .content()) { data in
    ...
    @IBAction func fetchRecommendation(_ sender: Any) {
        ...
        let fetchAction = UIAlertAction(title: "Fetch", style: .default, handler: { _ -> Void in
            ...
            Sendsay.shared.fetchRecommendation(with: options) { (result: Result<MyRecommendationResponse>) in
                switch result {
