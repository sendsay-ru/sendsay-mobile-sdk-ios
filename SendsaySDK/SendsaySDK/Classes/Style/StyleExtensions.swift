...
public extension UIColor {
    ...
    static let colorPrimary: UIColor = UIColor(hexString: "#943853")!
    static let colorPrimaryDark: UIColor = UIColor(hexString: "#9c224a")!
    static let colorAccent: UIColor = UIColor(hexString: "#e26284")!
    static let bgDark: UIColor = UIColor(white: 0, alpha: 0.5)
    static let textSecondary: UIColor = UIColor(white: 255, alpha: 0.5)
            ...
            if hex.hasPrefix("#") {
                ...
                if hexColor.count == 8 {
                    ...
                    if scanner.scanHexInt64(&hexNumber) {
                        ...
                        self.init(red: r, green: g, blue: b, alpha: alpha ?? 1)
                        return
                    }
                }
            }
    ...
    convenience init?(rgbaString: String) {
        ...
        do {
            ...
            guard let rgbaResult = rgbaValues.first,
                ...
                SendsaySDK.Sendsay.logger.log(.warning, message: "Unable to parse RGBA color \(rgbaString)")
                return nil
            }
            self.init(red: red / 255, green: green / 255, blue: blue / 255, alpha: alpha)
        } catch let error {
            SendsaySDK.Sendsay.logger.log(
                .warning,
    ...
    convenience init?(rgbString: String) {
        ...
        do {
            ...
            guard let rgbResult = rgbValues.first,
                ...
                SendsaySDK.Sendsay.logger.log(.warning, message: "Unable to parse RGB color \(rgbString)")
                return nil
            }
    ...
    convenience init?(argbString: String) {
        ...
        do {
            ...
            guard let argbResult = argbValues.first,
                ...
                SendsaySDK.Sendsay.logger.log(.warning, message: "Unable to parse ARGB color \(argbString)")
                return nil
            }
            self.init(red: red / 255, green: green / 255, blue: blue / 255, alpha: alpha)
        } catch let error {
    ...
    convenience init?(cssName: String) {
        ...
        default:
            SendsaySDK.Sendsay.logger.log(.warning, message: "Unable to parse CSS color \(cssName)")
            return nil
        }
    }
