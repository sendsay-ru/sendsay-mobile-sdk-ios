...
/// Protocol of what types of events are available in the Sendsay SDK.
public protocol SendsayType: AnyObject {
    ...
    /// Identification of the flushing mode used in to send the data to the Sendsay API.
    ...
    func configure(
        ...
        automaticSessionTracking: Sendsay.AutomaticSessionTracking,
        defaultProperties: [String: JSONConvertible]?,
        inAppContentBlocksPlaceholders: [String]?,
        flushingSetup: Sendsay.FlushingSetup,
    ...
    /// Recommendations contain fields as defined on Sendsay backend.
