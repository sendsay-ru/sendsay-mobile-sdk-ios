    ...
    private var displayStates: [String: InAppContentBlocksDisplayStatus] {
        get {
            ...
            do {
                ...
                Sendsay.logger.log(.error, message: "Unable to deserialize in-app content block display states. \(error)")
                return [:]
            }
        }
        set {
            do {
                ...
                Sendsay.logger.log(.error, message: "Unable to save in-app content block display states. \(error)")
            }
        }
    }
