...
protocol FlushingManagerType {
    /// Flushing mode specifies how often and if should data be automatically flushed to Sendsay.
    ...
    /// Returns true if event database contains data that needs to be flushed to sendsay servers
