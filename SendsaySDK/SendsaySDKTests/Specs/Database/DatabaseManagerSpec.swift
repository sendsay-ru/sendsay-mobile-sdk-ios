...
class DatabaseManagerSpec: QuickSpec {
    ...
    override func spec() {
        ...
        let myProject = SendsayProject(baseUrl: "http://mock-url.com", projectToken: "mytoken", authorization: .none)
                ...
                describe("customer handling") {
                    ...
                    it("should not delete old customers with events assigned") {
                        ...
                        try! db.identifyCustomer(
                            ...
                            into: SendsayProject(projectToken: "mock", authorization: .none)
                        )
                        db.makeNewCustomer()
                        expect(db.customers.count).to(equal(2))
