...
final class AtomicValueSpec: QuickSpec {
    ...
    private let queue1 = DispatchQueue(label: "com.sendsay.SendsaySDK.atomicValueTestQueue1")
    private let queue2 = DispatchQueue(label: "com.sendsay.SendsaySDK.atomicValueTestQueue2")

    override func spec() {
        describe("Sendsay Atomic Property wrapper") {
            ...
            context("Complex multi-threading reading/writting") {
                ...
                DispatchQueue.global().async {
                    for i in 1...20 {
                        let label = "com.sendsay.SendsaySDK.atomicValueComplexTestQueue" + String(i)
