                ...
                it("should throw on invalid project token in project mapping") {
                    do {
                        _ = try Configuration(
                            ...
                            projectMapping: [
                                .sessionStart: [
                                    SendsayProject(projectToken: "token2", authorization: .none),
                                    SendsayProject(projectToken: "token3", authorization: .none)
                                ],
                                .sessionEnd: [
                                    SendsayProject(projectToken: "invalid token", authorization: .none)
                                ]
                            ],
                            authorization: Authorization.none,
                            baseUrl: "baseUrl"
                ...
                it("should get created correctly with project mapping", closure: {
                    do {
                        ...
                        let mapping: [EventType: [SendsayProject]] = [
                            .install: [
                                SendsayProject(projectToken: "testToken1", authorization: .token("authToken1"))
                            ],
                            .customEvent: [
                                SendsayProject(projectToken: "testToken2", authorization: .token("authToken2")),
                                SendsayProject(projectToken: "testToken3", authorization: .none)
                            ],
                            .payment: [
                                SendsayProject(
            ...
            context("getting project tokens", {
                ...
                it("should return project mapping tokens") {
                    ...
                    expect { projects[0] }.to(equal(
                        SendsayProject(baseUrl: "baseUrl", projectToken: "token", authorization: .none)
                    ))
