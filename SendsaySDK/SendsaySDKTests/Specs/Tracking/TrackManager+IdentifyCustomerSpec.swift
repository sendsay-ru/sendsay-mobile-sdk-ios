...
class TrackingManagerForIdentifyCustomerSpec: QuickSpec {
    override func spec() {
        describe("TrackingManager") {
            ...
            var configuration: SendsaySDK.Configuration!
            ...
            it("should store all customer tracks") {
                prepareEnvironment(true)
                Sendsay.shared.flushingMode = .immediate
                for i in 0...2 {
            ...
            it("should not duplicate events") {
                if Sendsay.shared.flushingManager != nil && Sendsay.shared.flushingManager!.hasPendingData() {
