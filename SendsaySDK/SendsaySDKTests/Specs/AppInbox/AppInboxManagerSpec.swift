                    ...
                    <div class="in-app-message modal-in-app-message " style="background-color: #ffffff">
                        ...
                        <div class="content">
                            ...
                            <div class="buttons">
                                ...
                                <span class="button" style="color:#ffffff;background-color:#f44cac" data-link="https://sendsay.com/web">
                                    Web
                                </span>
                                <span class="button" style="color:#ffffff;background-color:#f44cac" data-link="https://sendsay.com/deeplink" data-actiontype="deep-link">
                                    Https as Deeplink
                                </span>
                                ...
                                <span class="button" style="color:#ffffff;background-color:#f44cac" data-link="https://sendsay.com/fallback" data-actiontype="invalid_type">
                                    Fallback to browser
                                </span>
                            </div>
                        </div>
        ...
        it("should parse HTML message") {
            ...
            waitUntil(timeout: .seconds(30)) { done in
                appInboxManager.fetchAppInbox { result in
                    ...
                    guard let action2 = actions.first(where: { $0.url == "https://sendsay.com/web" }) else {
                        fail("WebAction not found")
                        done()
                        return
                    }
                    ...
                    guard let action3 = actions.first(where: { $0.url == "https://sendsay.com/deeplink" }) else {
                        fail("WebAction not found")
                        done()
                        return
                    }
                    ...
                    guard let action5 = actions.first(where: { $0.url == "https://sendsay.com/fallback" }) else {
                        fail("WebAction not found")
                        done()
                        return
                    }
