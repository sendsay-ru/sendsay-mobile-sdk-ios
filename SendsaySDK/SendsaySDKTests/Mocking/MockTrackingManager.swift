...
internal class MockTrackingManager: TrackingManagerType {
    ...
    lazy var notificationsManager: PushNotificationManagerType = PushNotificationManager(
        trackingConsentManager: Sendsay.shared.trackingConsentManager!,
    ...
    func trackDeliveredPushEvent(_ eventObject: SendsaySDK.EventTrackingObject) {
    ...
    func processTrack(
        _ type: SendsaySDK.EventType,
        with data: [SendsaySDK.DataType]?,
    ...
    func anonymize(sendsayProject: SendsayProject, projectMapping: [EventType: [SendsayProject]]?) throws {
        fatalError("Not implemented")
    }
    ...
    func trackInAppContentBlockClick(
        ...
        action: SendsaySDK.InAppContentBlockAction,
        message: SendsaySDK.InAppContentBlockResponse,
        trackingAllowed: Bool
    ) {
        fatalError("Not implemented")
    }

    func trackInAppContentBlockClose(placeholderId: String, message: SendsaySDK.InAppContentBlockResponse, trackingAllowed: Bool) {
        fatalError("Not implemented")
    }

    func trackInAppContentBlockShow(placeholderId: String, message: SendsaySDK.InAppContentBlockResponse, trackingAllowed: Bool) {
        fatalError("Not implemented")
    }

    func trackInAppContentBlockError(placeholderId: String, message: SendsaySDK.InAppContentBlockResponse, errorMessage: String, trackingAllowed: Bool) {
        fatalError("Not implemented")
    }
    ...
    func trackInAppMessageClose(message: SendsaySDK.InAppMessage, closeButtonText: String?, trackingAllowed: Bool, isUserInteraction: Bool) {
    ...
    func trackInAppMessageShown(message: SendsaySDK.InAppMessage, trackingAllowed: Bool) {
        self.track(.show, for: message, trackingAllowed: trackingAllowed)
    }

    func trackInAppMessageError(message: SendsaySDK.InAppMessage, error: String, trackingAllowed: Bool) {
